<template>
  <div>
    <el-divider content-position="left"><span style="font-size:xx-small;color:#409EFF;">申请信息</span></el-divider>
      <el-form :model="emaPartLibrary" :rules="rules" ref="emaPartLibrary" class="table" label-width="100px" size="small" >
        ...
        <el-form-item label="领用类型：" prop="type">
          <el-select v-model="emaPartLibrary.type" placeholder="请选择类型">
            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="申请日期：" prop="date">
          <el-date-picker v-model="emaPartLibrary.date" type="date" placeholder="选择日期"></el-date-picker>
        </el-form-item>
    ...
    <div style="text-align:center;">
      <el-button type="primary" @click="nextStep(emaPartLibrary)" style="margin:10px;">下一步</el-button>
      <el-button  @click="over" style="margin:10px;">撤销</el-button>
    </div>
  </div>
</template>
<script>
