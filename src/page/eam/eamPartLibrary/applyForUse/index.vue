<template>
  <div :style="{height:$store.state.contentHeight+'px',padding:'10px',background:'#fff'}" class="cardHeight">
    ...
    <div class="operatorHeight">
      <el-button type="primary" icon="el-icon-edit" class="buttonHeight" size="small" @click="handleAdd()">领用申请</el-button>
    ...
    <template>
      <el-table :data="tableData" ref="multipleTable" class="tableHeight" :max-height="htable">
        ...
        <el-table-column fixed prop="code" label="出库编号" width="180"></el-table-column>
    ...
    <el-dialog title="领用申请详情" :visible.sync="dialogTableVisible" >
      ...
      <div>
        ...
        <el-divider></el-divider>
        <el-table :data="gridData" size="mini" stripe border>
