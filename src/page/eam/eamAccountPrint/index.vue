        ...
        <el-col :md="24">
              ...
              <el-row :gutter="48">
                <el-col :md="8" :sm="24">
                  <el-form-item label="设备编号">
                    <el-input v-model="queryParam.deviceNum" placeholder />
                  </el-form-item>
                </el-col>
                <el-col :md="8" :sm="24">
                ...
                <template v-if="advanced">
                  <el-col :md="8" :sm="24">
                    <el-form-item label="设备名称">
                      <el-input v-model="queryParam.deviceName" style="width: 100%" />
                    </el-form-item>
                  </el-col>
                  <el-col :md="8" :sm="24">
                  ...
                  <el-col :md="8" :sm="24">
                    <el-form-item label="使用状态">
                      <el-select v-model="queryParam.useStatus" placeholder="请选择" >
          ...
          <template>
            <el-table :data="tableData" border style="width: 100%" size="medium">
              ...
              <el-table-column fixed prop="deviceImg" label="设备图片" width="80">
              ...
              <el-table-column fixed prop="deviceNum" label="设备编号" width="150"></el-table-column>
              <el-table-column fixed prop="deviceName" label="设备名称" width="120"></el-table-column>
              ...
              <el-table-column prop="installLocation" label="安装位置" width="120"></el-table-column>
              <el-table-column prop="runDate" label="启用日期" width="120"></el-table-column>
              ...
              <el-table-column prop="buyingPrice" label="采购价格" width="100"></el-table-column>
