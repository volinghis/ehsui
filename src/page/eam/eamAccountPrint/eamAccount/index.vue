              ...
              <el-row :gutter="20">
                ...
                <el-col :md="6" :sm="24" :xs="24">
                  <el-form-item label="设备名称:">
                    <el-input v-model="queryParam.deviceNum" size="small" />
                  </el-form-item>
                </el-col>
                <el-col :md="6" :sm="24" :xs="24">
                  <el-form-item label="负责人:">
                    <el-input v-model="queryParam.deviceName" size="small" />
                  </el-form-item>
                </el-col>
                <el-col :md="6" :sm="24" :xs="24">
              ...
              <el-row :gutter="20">
                ...
                <el-col :md="6" :sm="24" :xs="24">
                  <el-form-item label="生产厂家:">
                    <el-input v-model="queryParam.factoryName" size="small" />
                  </el-form-item>
                </el-col>
                <el-col :md="6" :sm="24" style="padding-top:5px;">
                  <el-button
                    type="primary"
                    size="small"
                    ...
                    >查询</el-button
                  >
                  <el-button size="small" @click="() => (queryParam = {})"
                    >重置</el-button
                  >
                </el-col>
              </el-row>
          ...
          <div class="table-list">
            <template>
              ...
              >
                ...
                <el-table-column prop="deviceImg" label="设备图片" width="80">
