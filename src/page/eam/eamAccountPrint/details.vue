                ...
                <el-card shadow="hover">
                    <div slot="header" class="devDetailsTitle item-title" size="small">
                     ...
                     <div class="accountPrints">
                        <el-row>
                            <el-col>
                                <el-image style="width: 150px; height: 150px" src="https://i.loli.net/2019/11/07/2STd8zUw6x5hWaM.jpg" fit="fill" :preview-src-list="srcList"></el-image>
                            </el-col>
                            <el-col>
                ...
                <el-card style="margin-bottom:12px;" shadow="hover">
                     <div slot="header" class="partTitle item-title">
                        ...
                        <el-table :data="partData" style="width: 100%"  :highlight-current-row="true">
                            ...
                            <el-table-column prop="manufacturer" label="生产商" width="150"></el-table-column>
                            <el-table-column prop="supplier" label="供应商"></el-table-column>
                            <el-table-column prop="materialTypeName" label="物资类型"></el-table-column>
                            <el-table-column prop="labelCode" label="标签码"  width="150"></el-table-column>
                        ...
                        <el-col :md="24" :lg="15">
                             <el-card shadow="hover">
                                ...
                                <el-table :data="tableData" style="width: 100%">
                                    ...
                                    <el-table-column prop="address" label="检修内容" width="180" :show-overflow-tooltip="true"></el-table-column>
                                </el-table>
                             </el-card>
                        </el-col>
                        <el-col :md="24" :lg="9">
                                ...
                                <el-table :data="modifyData" style="width: 100%">
                                    <el-table-column prop="name" label="修改人" >
                                        <template slot-scope="scope">
                                            <a href="#" style="text-decoration:none;">{{ scope.row.name }}</a>
